...
public class Principal
{
	...
	public static void main(String[] args)
	{
		...
		libro2.setnEjemplares(ejemplares);
		...
		System.out.println("Ejemplares: " + libro1.getnEjemplares());
		System.out.println("Prestados: " + libro1.getnPrestados());
		System.out.println();
		...
		System.out.println("Ejemplares: " + libro2.getnEjemplares());
		System.out.println("Prestados: " + libro2.getnPrestados());
		System.out.println();
